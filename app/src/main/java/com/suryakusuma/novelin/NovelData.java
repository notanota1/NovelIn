...
public class NovelData {
    public static List<Novel> getAllNovels() {
        ...
        list.add(new Novel(
                ...
                R.drawable.novel12,
                Arrays.asList(new Novel.Chapter("Chapter 1: Once upon a time...", "woman_in_white.txt"))
        ));
        list.add(new Novel(
                ...
                R.drawable.novel11,
                Arrays.asList(new Novel.Chapter("Chapter 1: Once upon a time...", "and_then_there_were_none.txt"))
        ));
        list.add(new Novel(
                ...
                R.drawable.novel10,
                Arrays.asList(new Novel.Chapter("Chapter 1: Once upon a time...", "midnight_library.txt"))
        ));
        list.add(new Novel(
                "Harry Potter",
                "J.K. Rowling",
                ...
                R.drawable.novel9,
                Arrays.asList(new Novel.Chapter("Chapter 1: Once upon a time...", "harry_potter.txt"))
        ));
        list.add(new Novel(
                "Metamorphosis",
                "Franz Kafka",
                ...
                R.drawable.novel8,
                Arrays.asList(new Novel.Chapter("Chapter 1: he woke up with the body of a cockroach...", "metamorphosis.txt"))
        ));
        list.add(new Novel(
                "The Little Prince",
                ...
                R.drawable.novel7,
                Arrays.asList(new Novel.Chapter("Chapter 1: He is a young, curious boy with golden hair who asks many questions...", "little_prince.txt"))
        ));
        list.add(new Novel(
                ...
                R.drawable.novel6,
                Arrays.asList(new Novel.Chapter("Chapter 1: Suddenly he is approached by a devil...", "if_cat_disappeared.txt"))
        ));
        list.add(new Novel(
                "Animal Farm",
                "George Orwell",
                ...
                R.drawable.novel4,
                Arrays.asList(new Novel.Chapter("Chapter 1: on a farm...", "animal_farm.txt"))
        ));
        list.add(new Novel(
                "Don Quixote",
                ...
                R.drawable.novel3,
                Arrays.asList(new Novel.Chapter("Chapter 1: Once upon a time...", "don_quixote.txt"))
        ));
        list.add(new Novel(
                "Solo Leveling",
                "Chugong",
        ...
        list.add(new Novel(
                ...
                R.drawable.novel1,
                Arrays.asList(
                    new Novel.Chapter("Chapter 1: Three Ways to Survive in a Ruined World", "omniscient_reader.txt")
                )
        ));
        list.add(new Novel(
                ...
                R.drawable.novel2,
                Arrays.asList(
                    new Novel.Chapter("Chapter 1: A King's End", "tbate.txt")
                )
        ));
        return list;
    }
